...
plot(f1_score ~ size, data=sgd_f, type="l", log="x", col="blue", ylim=c(0,0.6))
...
<<results="asis", fig.height=4.2>>=
plot(f1_score ~ size, data=sgd_t, type="l", log="x", col="blue", ylim=c(0,0.6))
...
<<results="asis">>=
print(xtable(adt), table.placement="H", include.rownames=F, floating=F, tabular.environment="longtable")
@
\end{document}
